...
function Window({ children, name }) {
  ...
  return createPortal(
    <div className="fixed top-0 left-0 z-10 w-full h-full transition-all duration-500 bg-gray-100 bg-opacity-50 dark:bg-gray-800 dark:bg-opacity-50 backdrop-filter backdrop-blur">
      <div
        className="fixed max-h-[75vh] overflow-y-scroll px-3 py-4 transition-all duration-300 transform -translate-x-1/2 -translate-y-1/2 bg-gray-100 border-2 shadow-md top-1/2 left-1/2 dark:bg-gray-800"
        ref={ref}
      >
